...
const Header = () => {
  return (
    <header className="container mx-auto p-4 md:px-8 md:py-4 flex items-center gap-4 justify-between lg:justify-between lg:gap-6">
      {/* logo */}
      <div className="flex items-center justify-start lg:justify-center">
        <svg
          ...
          height="36"
          width="36"
          className="inline-block lg:h-10 lg:w-10"
        >
      ...
      {/* search Box */}
      <div className="relative w-full max-w-[260px] sm:max-w-xs md:max-w-md lg:max-w-lg xl:max-w-lg">
        <input
          type="search"
          placeholder="Search for restaurant and food"
          className="w-full p-2.5 pr-10 rounded-xl bg-gray-50 border border-gray-300 focus:outline-none focus:ring-1 focus:ring-[#FF5500] text-xs sm:text-md lg:text-lg"
        />
